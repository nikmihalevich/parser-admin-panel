...
import { refreshOurProducts } from "../../actions/shopsActions";
                  ...
                  <div className="col-lg-12">
                    <div className="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 col-xs-12">
                      <div className="custom-box">
                        ...
                        <p>Данный процесс запустит обновление списка и характеристик наших продуктов для парсинга. <b>Рекомендуется запускать его перед парсингом, если продуктовая информация поменялась.</b></p>
                        {
                          this.props.shops.our_products_date_last_update 
                          &&
                          <>
                            <p>Дата последнего обновления:</p>
                            <p><b>{new Date(this.props.shops.our_products_date_last_update).toLocaleString()}</b></p>
                          </>
                        }
                        <Button
                          onClick={e => this.onOurProductsClick(e)}
                          loading={this.props.shops.our_products_loading}
                        >
                          Обновить
                        </Button>
                      </div>
